			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box">
							...
							<h2 class="title-2"><i class="icon-docs"></i> Manage Divisions <a href="{{ lurl('division/create') }}" class="pull-right">Add Division</a></h2>
							...
							<form name="listForm" method="POST">
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									{{--	<td style="width:2%" class="add-img-selector">
										...
										<td style="width:14%" class="add-img-td">
											@if($post->pdf)
											<a href="/storage/{{$post->pdf}}" target="_blank">PDF</a>
											@else
											-
											@endif
										</td>
										...
										<td style="width:10%" class="action-td">
											<div>
												@if ($post->user_id==$user->id and $post->archived==0)
													<p>
                                                        <a class="btn btn-primary btn-sm" href="{{ lurl('division/' . $post->id . '/edit') }}">
