						...
						<div class="row">
							<div class="col-12">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<input type="hidden" name="post_id" value="{{ $division->id }}">
									<fieldset>
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">
												<input id="title" name="name" placeholder="Name" class="form-control input-md{{ $titleError }}"
													   type="text" value="{{ old('name', $division->name) }}">
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												...
												@if($division->image)
											<label ><img src="{{ lurl('storage/' . $division->image) }}"></label>
											@endif
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-8">
												...
												@if($division->pdf)
												<label ><a href="{{ lurl('storage/' . $division->pdf) }}" target="_blank">PDF</a></label>
												@endif
											</div>
										</div>
										...
										<div class="form-group row pt-3">
											<div class="col-md-12 text-center">
												<?php $attr = ['slug' => slugify($division->name), 'id' => $division->id]; ?>
