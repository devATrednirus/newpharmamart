			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						<li><a href="{{ admin_url('banners') }}"><i class="fa fa-picture-o"></i> <span>Banners</span></a></li>

						<li><a href="{{ admin_url('searches') }}"><i class="fa fa-list-alt"></i> <span>Search History</span></a></li>

						<li><a href="{{ admin_url('messages') }}"><i class="fa fa-list-alt"></i> <span>Queries</span></a></li>


						<li><a href="{{ admin_url('enquiries') }}"><i class="fa fa-list-alt"></i> <span>Enquiries</span></a></li>
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						<li><a href="{{ admin_url('user_groups') }}"><i class="fa fa-user"></i> <span>Sellers Groups</span></a></li>
						<li><a href="{{ admin_url('users') }}"><i class="fa fa-user"></i> <span>Sellers</span></a></li>
						<li><a href="{{ admin_url('users?type=customer') }}"><i class="fa fa-user"></i> <span>Buyers</span></a></li>
						@endif
						...
						<li><a href="{{ admin_url('package_history') }}"><i class="fa fa-list-alt"></i> <span>Package History</span></a></li>
					</ul>
				</li>
				@endif
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						@if (auth()->user()->can('list-redirect') || userHasSuperAdminPermissions())
						<li><a href="{{ admin_url('redirects') }}"><i class="fa fa-cog"></i> <span>Redirects</span></a></li>
						@endif
						...
						<li><a href="{{ admin_url('buy-leads') }}"><i class="fa fa-pie-chart"></i> <span>Buy Lead {{ trans('admin::messages.packages') }}</span></a></li>
						@endif
