<div class="box box-primary">
						...
						<tr>
							...
							<td>
								<a href="{{ admin_url('users/' . $user->id . '/edit') }}">
									{{ ($user->first_name?$user->first_name.($user->last_name?" ".$user->last_name:""):$user->phone) }} 
								</a>
							</td>
	...
	<div class="box-footer clearfix">
		<a href="{{ admin_url('users?type=customer') }}" class="btn btn-sm btn-default btn-flat pull-right">{{ trans('admin::messages.View All Users') }}</a>
	</div>
	<!-- /.box-footer -->
</div>
