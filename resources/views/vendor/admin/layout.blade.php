...
<body class="hold-transition {{ config('larapen.admin.skin') }} sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-lg">
              <strong>{!! strtoupper(str_limit(config('app.name'), 25, '')) !!}</strong>
          </span>
        </a>
      ...
      <footer class="main-footer">
        @if (config('larapen.admin.show_powered_by'))
            <div class="pull-right hidden-xs">
                ...
                @else
					{{ trans('admin::messages.powered_by') }} <a target="_blank" href="http://www.pharmafranchisemart.com">Pharmafranchisemart</a>.
                @endif
            </div>
        @endif
	...
	<script>
      ...
      $("a[data-original-title='Impersonate this user']").each(function(){
          $(this).attr('target', '_private');
      });
