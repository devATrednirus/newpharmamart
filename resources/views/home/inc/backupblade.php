    ...
    <div class="row justify-content-center">
          <div class="col-md-12">
              <div class="category-title">
                <h2 style="text-align: center;font-size:30;margin:20px 0px;"><a style="color:#000;font-family:'poppins'; " href="{{ lurl(trans('routes.v-search-cat', $attr), $attr) }}">{{ $cat->name }}</a></h2>	
              {{-- <a class="v-all-btns" href="{{ lurl('/sitemap/'.$cat->slug) }}">View All</a> --}}
             ...
             <img src="{{ \Storage::url($scat->picture) . getPictureVersion() }}"" alt="{{ $alttag }}" width="150px" height="150px">
             <h3><a href="{{ lurl(trans('routes.v-search-cat', $attr), $attr) }}">{{ $scat->name }}</a></h3>
      <a class="cat-links" href="{{ lurl(trans('routes.v-search-cat', $attr), $attr) }}">View all</a>
	    ...
	    <div class="container-fluid">
		    <div class="section-bg">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<h2 class="feat">Featured Company</h2>
							<div class="row">
	    ...
	    <div class="container-fluid">
		    <div class="section-bg">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<h2 style="text-align: center;font-size:30;margin:20px 0px;">Find Suppliers from Top Cities</h2>
	    ...
	    <div class="container-fluid">
		    <div class="section-bg">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<h2 class="feat">Featured Categories</h2>
							<div class="row">
...
<style>
 h1,h2,h3,h4,h5,h5,p,a,li,span,strong , div{
font-family: 'poppins';
}
 .title-with-bg h2 {
