<style>
	...
	.mega_menu  .page_links .viewmore a {
		color: #ce0b2b !important;
	}
...
<div class="new-template2-container {{$template_color}}">
						...
						<div class="row">
							<div class="col-lg-3 customclss" style="padding-right:0px;">
								<a class="brand_link" href="{{ lurl($company_url) }}">
									...
									@if (!empty($userPhoto))
									<img src="/{{ $userPhoto }}" style="width:80px; alt=" {{ $sUser->name }}">
									@else
					...
					<div class="col-lg-5">
						<nav class="main_menu clearfix">
							<ul class="ul_li clearfix">
								<li><a class="{{($active=='home'?'activemenu':'')}}" href="{{ lurl($company_url) }}">Home</a></li>
								<li><a class="{{($active=='about-us'?'activemenu':'')}}" href="{{ lurl($about_us) }}">About us</a></li>
								<li class="menu_item_has_child">
									<a href="#!" class="{{($active=='product'?'activemenu':'')}}">Products</a>
													...
													<div class="col-lg-3">
														<div class="page_links"  >
															 ...
															 <a class="btn btn-danger" href="/{{$company_url}}/sitemap">View All Categories</a>
                                                                 ...
                                                                 <li><a href="{{ lurl($product_range) }}" class="{{($active=='product-range'?'activemenu':'')}}">Range</a></li>

								<li><a href="{{ lurl($contact_us) }}" class="{{($active=='contact-us'?'activemenu':'')}}">Contact us</a></li>
							</ul>
						</nav>
					</div>
	...
	<main>
			...
			<div class="sidebar_mobile_menu">
				...
				<div class="msb_widget mobile_menu_list clearfix">
					<ul class="ul_li_block clearfix">
						<li><a class="{{($active=='home'?'activemenu':'')}}" href="{{ lurl($company_url) }}">Home</a></li>
						<li><a class="{{($active=='about-us'?'activemenu':"style='padding-top: 25px !important'")}}" href="{{ lurl($about_us) }}">About us</a></li>
						<li class="dropdown" style="height:auto; overflow-y:scroll;">
							<a href="#!" onclick="open_menu()" class="{{($active=='products'?'activemenu':"style='padding-top: 25px !important'")}}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Products</a>
		...
		<div class="main-content-temp2">
			@if($active=='home')
			@include('search.inc.template2.home')
			@elseif($active=='products')
			@include('search.inc.template2.products')
			@elseif($active=='about-us')
			@include('search.inc.template2.about_us')
			@elseif($active=='contact-us')
			@include('search.inc.template2.contact_us')
                        @elseif($active=='product-range')
			@include('search.inc.template2.product_range')
