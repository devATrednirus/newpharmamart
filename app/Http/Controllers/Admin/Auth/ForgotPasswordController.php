...
use App\Http\Controllers\Admin\Auth\Traits\SendsPasswordResetSmsTrait;
...
class ForgotPasswordController extends Controller
{
    ...
    */
     ...
     */
    public function sendResetLinkEmaila(ForgotPasswordRequest $request)
    {
		// Get the right login field
		
        $field = getLoginField($request->input('email'));
