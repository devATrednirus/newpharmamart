...
class Picture extends BaseModel
{
	 ...
	 * @var array
	 */
	protected $fillable = ['post_id', 'filename', 'position', 'alttag', 'active'];
	...
	*/
	...
	{
		// Get picture
		$out = '<img src="' . str_replace('storage','storage/app',resize($this->filename, 'small')) . '" style="width:auto; max-height:90px;">';
