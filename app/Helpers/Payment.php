...
class Payment
{
	 ...
	 */
	public static function paymentConfirmationActions($status, $payment,$marchant_txnid)
	{
  		...
  		if($status=="success"){
  			...
  			$payment->active = "1";
  			$payment->transaction_id = $marchant_txnid;
  			$payment->save();
  		}
		...
		/*if (isFromApi()) {
			...
			$message = "Your listing will be updated once payment completed";
