...
class CompanyQuickContacted extends Notification implements ShouldQueue
{
	use Queueable;
	...
	public function toMail($notifiable)
	{
 	...
 	//dd($this->msg);
		$mailMessage = (new MailMessage)
            ...
            ->line('<div style="background: #efefef;padding: 5px 15px;font-size: 17px;font-family: arial;font-weight: 600;" class="">Buyer is looking for "'.$this->msg->search_term.'"</div>')
            ->line('<div> 
...
// 			]))
	...
	protected function smsMessage()
	{
		...
		//return 'Dear '.$this->user->name.",\n\n".$this->msg->from_name."(".$this->msg->from_phone.") enquired for location ".$this->msg->location.":\n".$this->msg->message;
		

		$message = 'Dear '.substr($this->user->name,0,30).", ".substr($this->msg->from_name,0,20).", ".$this->msg->from_phone.", enquired for location ".$this->msg->location.", ".substr($this->msg->message,0,30);
