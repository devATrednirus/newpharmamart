...
class PackageExpired extends Notification implements ShouldQueue
{
	use Queueable;
	...
	public function toMail($notifiable)
	{
		...
		$mailMessage = (new MailMessage)
			->subject('Your '.config('app.name').' Subscription for '.$this->subscription->package->name.' package has been expired')
 ...
 */
	...
	protected function smsMessage()
	{
		...
		return "Dear ".substr($this->user->name,0,30).", Your Rednirus Listing Subscription for ".$this->subscription->package->name." package has been expired. For Help Reach Team Rednirus on @ 9888885364";
