...
// 			]))
	...
	protected function smsMessage()
	{
		...
		//return 'Dear '.$this->post->user->name.",\n\n".$this->msg->from_name."(".$this->msg->from_phone." : ".$this->msg->getVerifiedStatusHtml().") enquired for location ".$this->msg->location.":\n".$this->msg->message;

		$message = "Query from Rednirus\n".'Dear '.substr($this->post->user->name,0,30).", ".substr($this->msg->from_name,0,20).", ".$this->msg->from_phone.", enquired for location ".$this->msg->location.", ".substr($this->msg->message,0,30);
